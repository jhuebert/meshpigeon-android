...
import app.meshhop.feature.contacts.ContactsScreen
import app.meshhop.feature.messaging.ChatsScreen
import app.meshhop.feature.messaging.ConversationScreen
import app.meshhop.feature.onboarding.OnboardingScreen
...
import app.meshhop.ui.MeshHopTheme

/**
 * MeshHop main activity: offline-first home is Chats (00 principle 1),
...
@Composable
fun MeshHopApp(startOnOnboarding: Boolean = false) {
