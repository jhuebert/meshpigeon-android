...
object RadioNotifications {
    ...
    fun post(context: Context, notification: app.meshhop.domain.ReceivePipeline.Notification) {
    ...
    fun connection(context: Context, text: String): Notification {
        ...
        return NotificationCompat.Builder(context, CHANNEL_CONNECTION)
            ...
            .setContentTitle("MeshHop")
            .setContentText(text)
            .setOngoing(true)
            .build()
    }

    const val EXTRA_CONVERSATION = "app.meshhop.CONVERSATION_ID"
}
